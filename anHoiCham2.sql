...
CREATE TABLE `menu_tags` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_menu_tags_on_menu_id` (`menu_id`),
  KEY `index_menu_tags_on_tag_id` (`tag_id`),
  CONSTRAINT `fk_rails_74c250d0eb` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`),
  CONSTRAINT `fk_rails_be00874787` FOREIGN KEY (`menu_id`) REFERENCES `menus` (`id`)
...
INSERT INTO `menu_tags` VALUES (1,7,1,'2016-06-13 05:14:04','2016-06-13 05:14:04');
...
INSERT INTO `relationships` VALUES (1,1,3,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(2,1,4,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(3,1,5,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(4,1,6,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(5,4,1,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(6,5,1,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(7,6,1,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(8,7,1,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(9,8,1,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(10,9,1,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(11,10,1,'2016-06-07 16:15:55','2016-06-07 16:15:55'),(12,2,1,'2016-06-13 05:13:24','2016-06-13 05:13:24'),(13,3,1,'2016-06-13 05:14:31','2016-06-13 05:14:31');
...
INSERT INTO `tags` VALUES (1,'đãi khách',2,'2016-06-13 05:14:02','2016-06-13 05:14:02');
...
-- Dump completed on 2016-06-13 12:16:39
